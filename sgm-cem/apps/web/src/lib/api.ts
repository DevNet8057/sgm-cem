...
export function getBaseURL() {
  // NEXT_PUBLIC_API_URL est défini AU BUILD par Next.js (ARG Docker). En
  // production, il est TOUJOURS fourni par le Dockerfile ARG. Le fallback
  // hostname:3001 n'est JAMAIS atteint
